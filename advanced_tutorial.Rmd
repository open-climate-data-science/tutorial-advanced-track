...
nclimk<-rbind(nclim_2020s,nclim_2010s)%>%filter(date >= "2020-01-01" & date <="2020-12-31")
```
...
train_date <- nrow(temp_ts) *0.8
train <- temp_ts[1:train_date,]
test <- temp_ts[-c(1:train_date),]
```
